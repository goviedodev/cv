::: center
Gonzalo Eduardo Oviedo Lambert
*Analista Desarrollador FullStack Java - Spring Boot - SQL - GCP*\
...
Soy un **Software Engineer Senior** con más de 15 años de trayectoria en el desarrollo de aplicaciones críticas para el sector financiero y corporativo. Mi experiencia core se centra en el ecosistema **Java (Spring Boot)**, complementada por una sólida especialización en **SQL (Oracle y PostgreSQL)**.

He contributed en sectores de alta exigencia como **Finanzas (Citibank), EdTech (WebClass) y E-commerce (Perficient/Caterpillar)**. Mi perfil es integral (*Full-cycle*): infraestructura como código (**IaC**) usando **Pulumi en Google Cloud Platform**, y he liderado el desarrollo de interfaces modernas en su mayor parte con **Flutter**. Disfruto trabajar en equipos colaborativos en busca de soluciones que agreguen valor real al negocio.
...
**Frameworks:** Spring Boot, Spring MVC, Spring REST, Spring Beans\
**Bases de Datos:** Oracle PL/SQL, PostgreSQL\
**Cloud/Infraestructura:** Google Cloud (Pulumi IaC), Docker\
**Habilidades Secundarias**\
**Lenguajes:** JavaScript (ES6+), Bash, Elixir\
**Frameworks:** Vue.js, Nuxt, React, Struts\
**Infraestructura/Cloud:** Azure DevOps, AWS Lambda\
**Bases de Datos:** MongoDB, MySQL, SQL Server\
**Herramientas:** Jenkins, Jira, Confluence, Git, Eclipse, Gradle, Websphere
...
**Tecnologías:** Elixir, Ash Framework, Flutter, Java 21 (Spring Boot), GraalVM, Google Cloud, Pulumi\

- Arquitectura y desarrollo de plataforma de movilidad diseñando e implementando ciclos de vida de agentes y microservicios.
