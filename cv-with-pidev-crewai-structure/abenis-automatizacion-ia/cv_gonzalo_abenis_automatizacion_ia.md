...
**Ingeniero de Automatización de Procesos con IA**
Actual: Limache, Región de Valparaíso (Chile) · Reubicación: disponible para modalidad híbrida en Santiago, Región Metropolitana
+56 9 6372 3603 · goviedo.laboral@gmail.com · linkedin.com/in/gol · github.com/goviedodev
Español nativo · Inglés técnico intermedio-avanzado (B2)
...
**Stack:** Claude Code (plan Max), MCP, openspec, Elixir/Phoenix (Ash, Jido.AI), Java 21 (Spring Boot, Spring AI), Flutter, PostgreSQL + pgvector, Ollama, Google Cloud, Pulumi, Cloudflare Workers. En producción: app.tellevoapp.cl
...
### Roles previos — Hospital Cruz del Norte, Nubox, Cencosud, Portal Inmobiliario, Santander/Isban | 2000 – 2017
