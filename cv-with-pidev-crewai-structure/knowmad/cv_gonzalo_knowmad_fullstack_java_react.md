...
Actual: Limache, Región de Valparaíso (Chile) · Reubicación: disponible para reubicación inmediata en Madrid, España
...
### Tech Lead y Arquitecto — Plataforma de movilidad (Chile) | 2024 – Presente

**Stack:** Java 21 (Spring Boot), React Native, Flutter, PostgreSQL, Google Cloud, Pulumi IaC, Docker, Git. En producción: app.tellevoapp.cl
...
### Roles previos — Citibank, Nubox, Cencosud, Portal Inmobiliario, Santander/Isban | 2000 – 2022
