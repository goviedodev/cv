...
\textbf{Desarrollador y Analista de Software} | \textit{Experiencia Diversa (Summit, Nubox, Creasys / Isban)} \hfill 2013 -- 2020 \\
\begin{itemize}[noitemsep, topsep=0pt]
    \item \textbf{Gestión y Front-end (Summit):} Desarrollo web de sistemas KPI y reportes de marketing masivo. Implementación con Spring Boot, Vue.js, PHP y PostgreSQL en ecosistemas Cloud y Linux.
    \item \textbf{Refactorización (Nubox):} Migración de sistemas críticos, uso intensivo de JavaScript y desarrollo C\# para garantizar y ampliar la compatibilidad de plataformas base.
    \item \textbf{Backend y QA (Creasys / Santander / Ripley):} Desarrollo de servicios JAX-WS y uso de modelo de 3 capas en Java. Ejecución PL/SQL en Oracle, automatizaciones Bash y fuerte presencia en QA y cumplimiento de métricas SLA corporativas.
\end{itemize}
